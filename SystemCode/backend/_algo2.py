...
def initialize(context):
    ...
    context.stocks = all_portfolios[GRP][SUBGRP]['stocks']  # context.stocks = symbols('VXUS', 'VTI', 'BND', 'BNDX')
...
def rebalance(context, data):
    ...
    for stock in context.stocks:
        ...
        if (distance > 0):
            ...
            if (int(amount) == 0):
                continue
            print("Selling " + str(int(amount * -1)) + " shares of " + str(stock))
